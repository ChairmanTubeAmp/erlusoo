...
1. Now when you go to a site on the whitelist you should not see any errors, the page should load normally with the exception of whatever ads might be present on the page. They are blocked as a nice side effect. 
